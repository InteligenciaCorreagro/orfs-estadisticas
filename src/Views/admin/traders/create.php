<?php
// src/Views/admin/traders/create.php
ob_start();
$pageTitle = 'Crear Trader';
?>

<div class="page-header mb-3">
    <h1>Crear Nuevo Trader</h1>
    <p class="text-muted">Registrar nuevo corredor en el sistema</p>
</div>

<div class="card">
    <div class="card-body">
        <form method="POST" action="/admin/traders" id="traderForm">
...
document.getElementById('traderForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('/admin/traders', {
            method: 'POST',
            headers: {
        ...
        showNotification('Error al crear trader', 'danger');
    }
});
</script>
JS;
